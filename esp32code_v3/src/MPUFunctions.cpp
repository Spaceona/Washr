...
void mpu_init(Adafruit_MPU6050 &mpu, mpu6050_accel_range_t accel_range, mpu6050_gyro_range_t gyro_range,
...
String get_mpu_data(Adafruit_MPU6050 &mpu) {
    ...
    snprintf(buffer, sizeof(buffer),
             "{\"accelerometer\":{\"z\":%f,\"y\":%f,\"x\":%f},\"gyroscope\":{\"z\":%f,\"y\":%f,\"x\":%f}}",
             a.acceleration.z, a.acceleration.y, a.acceleration.x, g.gyro.z, g.gyro.y, g.gyro.x);
...
bool motion_detected(Adafruit_MPU6050 &mpu) {
    ...
    if (abs(a.acceleration.z) >= MPU_ACCEL_Z_THRESH || delta_x >= ACCEL_CHANGE_THRESH ||
